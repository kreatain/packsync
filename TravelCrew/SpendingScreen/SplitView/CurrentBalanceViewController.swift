...
class CurrentBalanceViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func configure(
        ...
        print("Current Balance received from parent: \(String(describing: currentBalance))")
...
//            }
    ...
    private func calculateTransactions() {
        print("[CurrentBalanceViewController] Recalculating transactions...")
        transactions = []
        guard let balance = currentBalance else { 
            print("[CurrentBalanceViewController] No current balance available.")
            return 
        }
        ...
        print("[CurrentBalanceViewController] Debtors: \(debtors), Creditors: \(creditors)")
        ...
        print("[CurrentBalanceViewController] Transactions calculated: \(transactions)")
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        print("[DEBUG] Number of rows: \(transactions.count)")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print("[CellForRowAt] Configuring cell for Transaction: \(transaction)")
