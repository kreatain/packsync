...
class ProfileViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    // Closure to notify SceneDelegate about badge updates
        ...
        db.collection("invitations")
            ...
            .addSnapshotListener { [weak self] (querySnapshot,
                ...
                DispatchQueue.main.async {
                    ...
                    let hasPendingInvitations = !(self?.invitations.isEmpty ?? true)
                    self?.onBadgeUpdate?(hasPendingInvitations) // Notify SceneDelegate
                }
            }
    }
